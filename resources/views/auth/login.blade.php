...
<div class="form-buttons mb-4">
  ...
  <a href="{{ route('auth.google') }}" class="btn-google d-flex justify-content-center align-items-center"><img
      src="/assets/brand/google-favicon.svg" alt="" srcset="">Continue com o google</a>
</div>
